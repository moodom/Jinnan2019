...
test_cfg = dict(
    ...
    rcnn=dict(
        score_thr=0.05,
        nms=dict(type='soft_nms', iou_thr=0.7, min_score=0),
        max_per_img=100,
        mask_thr_binary=0.5),
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'jinnan2_round2_train_20190401/train.json',
        img_prefix=data_root + 'jinnan2_round2_train_20190401/restricted/',
        img_scale=[(1600,1300),(1600,800)],
    ...
    test=dict(
        type=dataset_type,
        ann_file=data_root + 'test_round2_b.json',
        img_prefix=data_root + 'jinnan2_round2_test_b_20190424',
        # ann_file=data_root + 'jinnan2_round2_train_20190401/val.json',
        # img_prefix=data_root + 'jinnan2_round2_train_20190401/restricted/',
        img_scale=[(1600,720)],
        img_norm_cfg=img_norm_cfg,
